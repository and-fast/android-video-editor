package and.fast.video.effect.helper;


import and.fast.video.editor.R;
import and.fast.video.effect.filter.BarrelBlurEffect;
import and.fast.video.effect.filter.BlackAndWhiteEffect;
import and.fast.video.effect.filter.ContrastEffect;
import and.fast.video.effect.filter.CrossProcessEffect;
import and.fast.video.effect.filter.GammaEffect;
import and.fast.video.effect.filter.GlBilateralFilter;
import and.fast.video.effect.filter.GlBoxBlurFilter;
import and.fast.video.effect.filter.GlBulgeDistortionFilter;
import and.fast.video.effect.filter.GlCGAColorspaceFilter;
import and.fast.video.effect.filter.GlGaussianBlurFilter;
import and.fast.video.effect.filter.GlGrayScaleFilter;
import and.fast.video.effect.filter.GlHazeFilter;
import and.fast.video.effect.filter.GlInvertFilter;
import and.fast.video.effect.filter.GlMonochromeFilter;
import and.fast.video.effect.filter.GlSharpenFilter;
import and.fast.video.effect.filter.GlSphereRefractionFilter;
import and.fast.video.effect.filter.GlToneCurveFilter;
import and.fast.video.effect.filter.GlVignetteFilter;
import and.fast.video.effect.filter.HueEffect;
import and.fast.video.effect.filter.OverlayEffect;
import and.fast.video.effect.filter.PosterizeEffect;
import and.fast.video.effect.filter.SepiaEffect;
import and.fast.video.effect.filter.SketchEffect;
import and.fast.video.effect.filter.TemperatureEffect;
