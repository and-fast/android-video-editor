...
import and.fast.video.record.listener.CaptureListener;
import and.fast.video.record.util.CheckPermission;
import and.fast.video.record.util.LogUtil;

import static and.fast.video.record.JCameraView.BUTTON_STATE_BOTH;
import static and.fast.video.record.JCameraView.BUTTON_STATE_ONLY_CAPTURE;
import static and.fast.video.record.JCameraView.BUTTON_STATE_ONLY_RECORDER;
